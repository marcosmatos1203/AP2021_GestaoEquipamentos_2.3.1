...
namespace GestaoEquipamentos.ConsoleApp.Telas
{
    public class TelaChamado : TelaBase
    {
        ...
        public override void VisualizarRegistros()
        {
            ...
            {
                Console.WriteLine("{0,-10} | {1,-20} | {2,-35} | {3,-15} | {4,-15}",
        ...
        private static void MontarCabecalhoTabela()
        {
            ...
            Console.WriteLine("{0,-10} | {1,-20} | {2,-35} | {3,-15} | {4,-15}", "Id", "Equipamento", "Título", "Dias em Aberto", "Solicitante");
        ...
        private bool GravarChamado(int idChamadoSelecionado)
        {
            ...
            string resultadoValidacao = controladorChamado.
                RegistrarChamado(idChamadoSelecionado, idEquipamentoChamado, idSolicitanteChamado,
                titulo, descricao, dataAbertura);
